      ...
      <Cards>
        <Box display="flex" flexDirection="column">
          <iframe width="500" height="300"
            ...
            allowFullScreen />
          <Text textAlign="center" mt={12} fontWeight={700} fontSize={16}>Kata Omnichat 2.0</Text>
        </Box>
        <Box display="flex" flexDirection="column">
          <iframe width="500" height="300"
            ...
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen />
          <Text textAlign="center" mt={12} fontWeight={700} fontSize={16}>Qios Tutorial</Text>
        </Box>
      </Cards>
    </Box>
  )
