...
<Table>
  ...
  <TableBody>
    <TableBodyRow>
      ...
      <TableBodyCell>
        This error message will show if you push-ing your bot via Kata CLI. It means there is an error when creating the method. In this error message, you will find a specific error in the method.
      </TableBodyCell>
    </TableBodyRow>
  </TableBody>
</Table>
...
<Table>
  ...
  <TableBody>
    <TableBodyRow>
      ...
      <TableBodyCell>
        This error message will show if your bot already deployed to any channels. It means there is a failure when executing method(s).
      </TableBodyCell>
    </TableBodyRow>
  </TableBody>
</Table>
...
<Table>
  ...
  <TableBody>
    <TableBodyRow>
      ...
      <TableBodyCell>
        This error message will show if you push your bot via Kata CLI or publish via Platform. It means an error in doing mapping in transition.
      </TableBodyCell>
    </TableBodyRow>
  </TableBody>
</Table>
...
<Table>
  ...
  <TableBody>
    <TableBodyRow>
      ...
      <TableBodyCell>
        This error message will show if you push-ing your bot via Kata CLI. It means bot can not find NLU with specific name on creating intent **or** on creating intent attributes.
      </TableBodyCell>
    </TableBodyRow>
  </TableBody>
</Table>
...
<Table>
  ...
  <TableBody>
    <TableBodyRow>
      ...
      <TableBodyCell>
        This error message will show if you push-ing your bot via Kata CLI. It means it has a failure when executing NLU processors.
      </TableBodyCell>
    </TableBodyRow>
  </TableBody>
</Table>
...
<Table>
  ...
  <TableBody>
    <TableBodyRow>
      ...
      <TableBodyCell>
        This error message will show if you push-ing your bot via Kata CLI and publish in Kata Platform.. It means the initial state is not found.
      </TableBodyCell>
    </TableBodyRow>
  </TableBody>
</Table>
