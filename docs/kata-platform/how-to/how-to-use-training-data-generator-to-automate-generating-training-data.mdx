...
<ImageWrapper>
  <FigureImage
    ...
    caption={{ title: 'Figure 12', description: 'Data to generate must be equal to or below than total data possibilities.' }}
    layout="responsive"
    naturalWidth={2106}
    naturalHeight={1278}
  />
...
<ImageWrapper>
  <FigureImage
    ...
    caption={{ title: 'Figure 18', description: 'Data has been trained as `intent:statement`, `object:person` and `things`.' }}
    layout="responsive"
    naturalWidth={2106}
    naturalHeight={1278}
  />
