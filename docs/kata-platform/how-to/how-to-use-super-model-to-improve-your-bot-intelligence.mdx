...
<Table>
  ...
  <TableBody>
    ...
    <TableBodyRow>
      ...
      <TableBodyCell>
        General location, city, country, address
      </TableBodyCell>
      <TableBodyCell>
        Jakarta, Indonesia, Jln Pangeran Antasari 18A
      </TableBodyCell>
    </TableBodyRow>
    <TableBodyRow>
      <TableBodyCell>
      ...
      <TableBodyCell>
        business@mail.com, jobs@company.com
      </TableBodyCell>
    </TableBodyRow>
    <TableBodyRow>
      <TableBodyCell>
      ...
      <TableBodyCell>
        +62 80123456789, (021) 3456789, 021-5678-9012
      </TableBodyCell>
    </TableBodyRow>
    <TableBodyRow>
      <TableBodyCell>
      ...
      <TableBodyCell>
        hari ini, 17 Agustus 1945, tahun 2019, besok, 17/9/45, jam 3 siang, pagi ini, 19:00
      </TableBodyCell>
    </TableBodyRow>
    <TableBodyRow>
      <TableBodyCell>
      ...
      <TableBodyCell>
        Number in digit, number in word, sequence of number, mix number in digit and word
      </TableBodyCell>
      <TableBodyCell>
        123, 92, 9.000, satu, dua, tiga ribu, dua tiga, delapan tujuh, 9 juta, 5rb
      </TableBodyCell>
    </TableBodyRow>
    <TableBodyRow>
      <TableBodyCell>
      ...
      <TableBodyCell>
        IDR, SGD, rupiah, US dollar, Rp 5000, 5 ribu rupihah, $3, 9 USD
      </TableBodyCell>
    </TableBodyRow>
    <TableBodyRow>
      <TableBodyCell>
      ...
      <TableBodyCell>
        5 meter persegi, sepuluh m2, 200 ha
      </TableBodyCell>
    </TableBodyRow>
    <TableBodyRow>
      <TableBodyCell>
      ...
      <TableBodyCell>
        3 jam, 10 detik, 5 jam 30 menit, sehari, dua hari
      </TableBodyCell>
    </TableBodyRow>
    <TableBodyRow>
      <TableBodyCell>
...
<Table>
  ...
  <TableBody>
    ...
    <TableBodyRow>
      ...
      <TableBodyCell>
        Use this output type if your entity type is “dictionary”. It will result in an array consisting of keys and labels.
      </TableBodyCell>
    </TableBodyRow>
    <TableBodyRow>
      <TableBodyCell>
      ...
      <TableBodyCell>
        Using supermodel “kata entity”, you must use this output type.
      </TableBodyCell>
    </TableBodyRow>
  </TableBody>
</Table>
