...
<Table>
  ...
  <TableBody>
    <TableBodyRow>
      ...
      <TableBodyCell>
        Name of your action. Max. 30 characters with alphanumeric.
      </TableBodyCell>
    </TableBodyRow>
    <TableBodyRow>
      <TableBodyCell>
      ...
      <TableBodyCell>
        Which condition can trigger this action
      </TableBodyCell>
    </TableBodyRow>
    <TableBodyRow>
      <TableBodyCell>
    ...
    <TableBodyRow>
      ...
      <TableBodyCell>
        Input API body by creating key and value.
      </TableBodyCell>
    </TableBodyRow>
    <TableBodyRow>
      <TableBodyCell>
      ...
      <TableBodyCell>
        Input API headers by creating key and value.
      </TableBodyCell>
    </TableBodyRow>
    <TableBodyRow>
      <TableBodyCell>
