...
<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-1.webp" alt="bcms-1" />
</ImageWrapper>
...
<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-2.webp" alt="bcms-2" />
</ImageWrapper>

Click on Create to submit data. Successfully created environment will be seen as follow

<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-3.webp" alt="bcms-3" />
</ImageWrapper>
...
<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-4.webp" alt="bcms-4" />
</ImageWrapper>
...
<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-5.webp" alt="bcms-5" />
</ImageWrapper>

There is a breadcrumb on top left to indicate which page you are in. Click on “+” button to create a form

<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-6.webp" alt="bcms-6" />
</ImageWrapper>

Fill in the fields as follows

<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-7.webp" alt="bcms-7" />
</ImageWrapper>

Then, click on “Order Pizza” form you've just created

<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-8.webp" alt="bcms-8" />
</ImageWrapper>
...
<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-9.webp" alt="bcms-9" />
</ImageWrapper>
...
<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-10.webp" alt="bcms-10" />
</ImageWrapper>
...
<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-11.webp" alt="bcms-11" />
</ImageWrapper>
...
<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-12.webp" alt="bcms-12" />
</ImageWrapper>
...
<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-13.webp" alt="bcms-13" />
</ImageWrapper>

Then, click on Add User button

<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-14.webp" alt="bcms-14" />
</ImageWrapper>

Next, Add User drawer will show

<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-15.webp" alt="bcms-15" />
</ImageWrapper>

Fill in e-mail and choose Development environment . Then click Add to send an invitation to that user's email.

<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-16.webp" alt="bcms-16" />
</ImageWrapper>
...
<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-17.webp" alt="bcms-17" />
</ImageWrapper>
...
<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-18.webp" alt="bcms-18" />
</ImageWrapper>
...
<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-20.webp" alt="bcms-20" />
</ImageWrapper>
...
<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-21.webp" alt="bcms-21" />
</ImageWrapper>

Then, go to Environment to change deployment. Click on more button to update.

<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-22.webp" alt="bcms-22" />
</ImageWrapper>

Next, click Update. Update environment drawer will appear.

<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-23.webp" alt="bcms-23" />
</ImageWrapper>

Choose latest deployment then click Update. Changes will be shown as follow

<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-24.webp" alt="bcms-24" />
</ImageWrapper>
...
<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-25.webp" alt="bcms-25" />
</ImageWrapper>

Click on Login after you filled in username/e-mail and password.

<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-26.webp" alt="bcms-26" />
</ImageWrapper>
...
<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-27.webp" alt="bcms-27" />
</ImageWrapper>
...
<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-28.webp" alt="bcms-28" />
</ImageWrapper>

Testing for fallback:

<ImageWrapper>
  <NextImage src="/assets/images/tutorials/bot-cms/bcms-29.webp" alt="bcms-29" />
</ImageWrapper>
