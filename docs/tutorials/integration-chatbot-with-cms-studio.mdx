...
<FigureImage src="/assets/images/tutorials/bot-cms/bcms-1.webp" alt="bcms-1" />
...
<FigureImage src="/assets/images/tutorials/bot-cms/bcms-2.webp" alt="bcms-2" />

Click on Create to submit data. Successfully created environment will be seen as follow

<FigureImage src="/assets/images/tutorials/bot-cms/bcms-3.webp" alt="bcms-3" />
...
<FigureImage src="/assets/images/tutorials/bot-cms/bcms-4.webp" alt="bcms-4" />
...
<FigureImage src="/assets/images/tutorials/bot-cms/bcms-5.webp" alt="bcms-5" />

There is a breadcrumb on top left to indicate which page you are in. Click on “+” button to create a form

<FigureImage src="/assets/images/tutorials/bot-cms/bcms-6.webp" alt="bcms-6" />

Fill in the fields as follows

<FigureImage src="/assets/images/tutorials/bot-cms/bcms-7.webp" alt="bcms-7" />

Then, click on “Order Pizza” form you've just created

<FigureImage src="/assets/images/tutorials/bot-cms/bcms-8.webp" alt="bcms-8" />
...
<FigureImage src="/assets/images/tutorials/bot-cms/bcms-9.webp" alt="bcms-9" />
...
<FigureImage src="/assets/images/tutorials/bot-cms/bcms-10.webp" alt="bcms-10" />

### Add Fallback Text to Form

Fill in text box element as follow

<FigureImage src="/assets/images/tutorials/bot-cms/bcms-11.webp" alt="bcms-11" />
...
<FigureImage src="/assets/images/tutorials/bot-cms/bcms-12.webp" alt="bcms-12" />
...
<FigureImage src="/assets/images/tutorials/bot-cms/bcms-13.webp" alt="bcms-13" />

Then, click on Add User button

<FigureImage src="/assets/images/tutorials/bot-cms/bcms-14.webp" alt="bcms-14" />

Next, Add User drawer will show

<FigureImage src="/assets/images/tutorials/bot-cms/bcms-15.webp" alt="bcms-15" />

Fill in e-mail and choose Development environment . Then click Add to send an invitation to that user's email.

<FigureImage src="/assets/images/tutorials/bot-cms/bcms-16.webp" alt="bcms-16" />
...
<FigureImage src="/assets/images/tutorials/bot-cms/bcms-17.webp" alt="bcms-17" />
...
<FigureImage src="/assets/images/tutorials/bot-cms/bcms-18.webp" alt="bcms-18" />
...
<FigureImage src="/assets/images/tutorials/bot-cms/bcms-20.webp" alt="bcms-20" />
...
<FigureImage src="/assets/images/tutorials/bot-cms/bcms-21.webp" alt="bcms-21" />

Then, go to Environment to change deployment. Click on more button to update.

<FigureImage src="/assets/images/tutorials/bot-cms/bcms-22.webp" alt="bcms-22" />

Next, click Update. Update environment drawer will appear.

<FigureImage src="/assets/images/tutorials/bot-cms/bcms-23.webp" alt="bcms-23" />

Choose latest deployment then click Update. Changes will be shown as follow

<FigureImage src="/assets/images/tutorials/bot-cms/bcms-24.webp" alt="bcms-24" />
...
<FigureImage src="/assets/images/tutorials/bot-cms/bcms-25.webp" alt="bcms-25" />

Click on Login after you filled in username/e-mail and password.

<FigureImage src="/assets/images/tutorials/bot-cms/bcms-26.webp" alt="bcms-26" />

### Edit Content in CMS Client

Click on available form which is “Order Pizza”

<FigureImage src="/assets/images/tutorials/bot-cms/bcms-27.webp" alt="bcms-27" />
...
<FigureImage src="/assets/images/tutorials/bot-cms/bcms-28.webp" alt="bcms-28" />

Testing for fallback:

<FigureImage src="/assets/images/tutorials/bot-cms/bcms-29.webp" alt="bcms-29" />
