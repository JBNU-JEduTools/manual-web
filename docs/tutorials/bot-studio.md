...
imgSpot: /assets/images/tutorial/spot-cms.webp
...
![bse-1](/assets/images/tutorial/bot-studio/bse-1.jpg)
...
![bse-2](/assets/images/tutorial/bot-studio/bse-2.webp)

Then fill the form with a username, an email, and an account type. Continue by clicking "Sign Up."

![bse-3](/assets/images/tutorial/bot-studio/bse-3.webp)
...
![bse-4](/assets/images/tutorial/bot-studio/bse-4.webp)
...
![bse-5](/assets/images/tutorial/bot-studio/bse-5.webp)

Click on “Create Project” and fill in the form. Each project contains one bot design, one NL, and one CMS.

![bse-6](/assets/images/tutorial/bot-studio/bse-6.webp)
...
![bse-8](/assets/images/tutorial/bot-studio/bse-8.webp)

Next, click “Create Flow” button to create `fallback` flow. Set flow to active, persistent, and default.

![bse-9](/assets/images/tutorial/bot-studio/bse-9.webp)
...
![bse-10](/assets/images/tutorial/bot-studio/bse-10.webp)

Then, fill in the form as follows

![bse-11](/assets/images/tutorial/bot-studio/bse-11.webp)

### Create State init

Next, we will create a state called `init`. Click the ”+” button at the bottom right of your screen.

![bse-12](/assets/images/tutorial/bot-studio/bse-12.webp)
...
![bse-13](/assets/images/tutorial/bot-studio/bse-13.webp)

Now we will create a bot response to display an apology message. Click “Add actions” button to create a response.

![bse-14](/assets/images/tutorial/bot-studio/bse-14.webp)

Container for creating action will appear

![bse-15](/assets/images/tutorial/bot-studio/bse-15.webp)

### Create Action Text in State init

Click on “+” button to create a new action.

![bse-16](/assets/images/tutorial/bot-studio/bse-16.webp)

Choose action type “Text”

![bse-17](/assets/images/tutorial/bot-studio/bse-17.webp)

Then, fill in the form

![bse-18](/assets/images/tutorial/bot-studio/bse-18.webp)

Click on “Create Action” button.

![bse-19](/assets/images/tutorial/bot-studio/bse-19.webp)
...
![bse-20](/assets/images/tutorial/bot-studio/bse-20.webp)

Click “Create” button. Your screen should look like this

![bse-21](/assets/images/tutorial/bot-studio/bse-21.webp)
...
![bse-22](/assets/images/tutorial/bot-studio/bse-22.webp)

Created flow will be shown like this

![bse-23](/assets/images/tutorial/bot-studio/bse-23.webp)
...
![bse-24](/assets/images/tutorial/bot-studio/bse-24.webp)

Next, click on “Create NLU”

![bse-25](/assets/images/tutorial/bot-studio/bse-25.webp)

Choose Keyword type and enter keywords that represents `order`, such as “order”, “pls order”, “order pza”.

![bse-26](/assets/images/tutorial/bot-studio/bse-26.webp)

Successfully created NLU looks like this

![bse-27](/assets/images/tutorial/bot-studio/bse-27.webp)
...
![bse-28](/assets/images/tutorial/bot-studio/bse-28.webp)
...
![bse-29](/assets/images/tutorial/bot-studio/bse-29.webp)

Click “Create” to create the intent. Your screen should look like this

![bse-30](/assets/images/tutorial/bot-studio/bse-30.webp)
...
![bse-31](/assets/images/tutorial/bot-studio/bse-31.webp)
...
![bse-33](/assets/images/tutorial/bot-studio/bse-33.webp)
...
![bse-39](/assets/images/tutorial/bot-studio/bse-39.webp)

Then, remove all actions in the state by clicking “x” on each action.

![bse-40](/assets/images/tutorial/bot-studio/bse-40.webp)
...
![bse-41](/assets/images/tutorial/bot-studio/bse-41.webp)

Enter `pizzaMenu` as name

![bse-42](/assets/images/tutorial/bot-studio/bse-42.webp)
...
![bse-43](/assets/images/tutorial/bot-studio/bse-43.webp)

Your second form should look like this

![bse-44](/assets/images/tutorial/bot-studio/bse-44.webp)

Finalize this step by clicking “Create Action.”

It should look like this

![bse-45](/assets/images/tutorial/bot-studio/bse-45.webp)
...
![bse-46](/assets/images/tutorial/bot-studio/bse-46.webp)

After you select `askOptions` action click “Create Action” button to finalize this step.

![bse-47](/assets/images/tutorial/bot-studio/bse-47.webp)

Your form should look like this

![bse-48](/assets/images/tutorial/bot-studio/bse-48.webp)
...
![bse-49](/assets/images/tutorial/bot-studio/bse-49.webp)

Click on Create Intent and create intent as follow

![bse-50](/assets/images/tutorial/bot-studio/bse-50.webp)

Successfully created intent looks like this

![bse-51](/assets/images/tutorial/bot-studio/bse-51.webp)
...
![bse-52](/assets/images/tutorial/bot-studio/bse-52.webp)

Fill in the form with these data, and click “Create”

![bse-52-1](/assets/images/tutorial/bot-studio/bse-52-1.webp)
...
![bse-53](/assets/images/tutorial/bot-studio/bse-53.webp)
...
![bse-54](/assets/images/tutorial/bot-studio/bse-54.webp)

Then you have to make self-transition in Transition tab as follow

![bse-54_1](/assets/images/tutorial/bot-studio/bse-54_1.webp)

Result:

![bse-55](/assets/images/tutorial/bot-studio/bse-55.webp)
...
![bse-56](/assets/images/tutorial/bot-studio/bse-56.webp)

Successfully created NLU will be shown like this

![bse-57](/assets/images/tutorial/bot-studio/bse-57.webp)
...
![bse-58](/assets/images/tutorial/bot-studio/bse-58.webp)

Successfully created intent will look like this

![bse-59](/assets/images/tutorial/bot-studio/bse-59.webp)
...
![bse-60](/assets/images/tutorial/bot-studio/bse-60.webp)

Created transition will look like this

![bse-61](/assets/images/tutorial/bot-studio/bse-61.webp)
...
![bse-62](/assets/images/tutorial/bot-studio/bse-62.webp)

Successfully created NLU will look like this
![bse-63](/assets/images/tutorial/bot-studio/bse-63.webp)
...
![bse-64](/assets/images/tutorial/bot-studio/bse-64.webp)

## Add mapping in onTransit tab

![bse-67](/assets/images/tutorial/bot-studio/bse-67.webp)

Don't forget to add self-transition in a state. Click Create Action. Your screen should look like this

![bse-65](/assets/images/tutorial/bot-studio/bse-65.webp)
...
![bse-66](/assets/images/tutorial/bot-studio/bse-66.webp)

Result will be shown as follows

![bse-68](/assets/images/tutorial/bot-studio/bse-68.webp)
...
![bse-69](/assets/images/tutorial/bot-studio/bse-69.webp)

Then, we will create an intent for keyword `no`

![bse-70](/assets/images/tutorial/bot-studio/bse-70.webp)

Both intent will appear as follows

![bse-71](/assets/images/tutorial/bot-studio/bse-71.webp)
...
![bse-72](/assets/images/tutorial/bot-studio/bse-72.webp)

![bse-73](/assets/images/tutorial/bot-studio/bse-73.webp)

Also, don't forget to add self transition in the state. Result:
![bse-74](/assets/images/tutorial/bot-studio/bse-74.webp)
...
![bse-75](/assets/images/tutorial/bot-studio/bse-75.webp)

Final flow:

![bse-76](/assets/images/tutorial/bot-studio/bse-76.webp)
...
![bse-77](/assets/images/tutorial/bot-studio/bse-77.webp)

![bse-78](/assets/images/tutorial/bot-studio/bse-78.webp)

Every time you publish a bot, it will record a hash number (similar to Git's hash number) in Revision List.

![bse-79](/assets/images/tutorial/bot-studio/bse-79.webp)

## Testing Your Chatbot

Click on Test Chatbot on Bot Studio then type “order” to initialize `order` flow.

![bse-80](/assets/images/tutorial/bot-studio/bse-80.webp)
...
![bse-81](/assets/images/tutorial/bot-studio/bse-81.webp)

Click on Create Deployment button on top right

![bse-82](/assets/images/tutorial/bot-studio/bse-82.webp)

Choose Patch on Deployment Version.

![bse-83](/assets/images/tutorial/bot-studio/bse-83.webp)

Succesfully created deployment looks like this.

![bse-84](/assets/images/tutorial/bot-studio/bse-84.webp)
...
![bse-85](/assets/images/tutorial/bot-studio/bse-85.webp)
...
![bse-86](/assets/images/tutorial/bot-studio/bse-86.webp)

Successfully created environment will look like this

![bse-87](/assets/images/tutorial/bot-studio/bse-87.webp)
...
![bse-88](/assets/images/tutorial/bot-studio/bse-88.webp)

Next, click “Create Channel” and fill in as follows

![bse-89](/assets/images/tutorial/bot-studio/bse-89.webp)
...
![bse-90](/assets/images/tutorial/bot-studio/bse-90.webp)

Click on Log in with LINE

![bse-91](/assets/images/tutorial/bot-studio/bse-91.webp)

Enter your email and password

![bse-92](/assets/images/tutorial/bot-studio/bse-92.webp)

After you successfully logged in, you will be redirected to provider list dashboard

![bse-93](/assets/images/tutorial/bot-studio/bse-93.webp)

**Create a Provider**

Click “Create New Provider”

![bse-94](/assets/images/tutorial/bot-studio/bse-94.webp)

Fill in provider name

![bse-95](/assets/images/tutorial/bot-studio/bse-95.webp)
...
![bse-96](/assets/images/tutorial/bot-studio/bse-96.webp)

### Setup Channel for LINE Integration

Setup channel in Messaging API by clicking Create Channel on Messaging API.

![bse-97](/assets/images/tutorial/bot-studio/bse-97.webp)

Fill in the form as follows

![bse-98](/assets/images/tutorial/bot-studio/bse-98.webp)

![bse-99](/assets/images/tutorial/bot-studio/bse-99.webp)

Next, you have to choose **Developer Trial as Plan**

![bse-100](/assets/images/tutorial/bot-studio/bse-100.webp)Continue to click Confirm.

Accept Terms of Use from LINE then click Create

![bse-101](/assets/images/tutorial/bot-studio/bse-101.webp)

Successfuly created channel will look like this

![bse-102](/assets/images/tutorial/bot-studio/bse-102.webp)
...
![bse-103](/assets/images/tutorial/bot-studio/bse-103.webp)

Then, issue dialog will pop up. Click on Issue to continue

![bse-104](/assets/images/tutorial/bot-studio/bse-104.webp)

Then, copy Channel Access Token below and paste it on Create Channel form in Kata | Platform

![bse-105](/assets/images/tutorial/bot-studio/bse-105.webp)

![bse-106](/assets/images/tutorial/bot-studio/bse-106.webp)

**Fill in Channel Secret field**

In Basic Information, copy Channel Secret from LINE to Kata | Platform

![bse-107](/assets/images/tutorial/bot-studio/bse-107.webp)

![bse-108](/assets/images/tutorial/bot-studio/bse-108.webp)

Final result in Kata | Platform will look like this

![bse-109](/assets/images/tutorial/bot-studio/bse-109.webp)

Click “Create” to generate webhook URL from Kata | Platform.

![bse-110](/assets/images/tutorial/bot-studio/bse-110.webp)
...
![bse-111](/assets/images/tutorial/bot-studio/bse-111.webp)
Click “Update” then paste the webhook URL to LINE developer console.

![bse-112](/assets/images/tutorial/bot-studio/bse-112.webp)

Click “Update” then click “Verify.”

![bse-113](/assets/images/tutorial/bot-studio/bse-113.webp)

Next, disable auto-reply messages and greeting messages

![bse-114](/assets/images/tutorial/bot-studio/bse-114.webp)

Voila! You have successfully deployed your bot to LINE Messenger.

Scan the QR Code in LINE Developer Console to add the bot.

![bse-115](/assets/images/tutorial/bot-studio/bse-115.webp)

Then, test to scan QR Code

![bse-116](/assets/images/tutorial/bot-studio/bse-116.webp)
