...
![bse-2](/assets/images/tutorial/bot-studio/bse-2.png)

Then fill the form with a username, an email, and an account type. Continue by clicking "Sign Up."

![bse-3](/assets/images/tutorial/bot-studio/bse-3.png)
...
![bse-4](/assets/images/tutorial/bot-studio/bse-4.png)
...
![bse-8](/assets/images/tutorial/bot-studio/bse-8.png)

Next, click “Create Flow” button to create `fallback` flow. Set flow to active, persistent, and default.

![bse-9](/assets/images/tutorial/bot-studio/bse-9.png)
...
![bse-10](/assets/images/tutorial/bot-studio/bse-10.png)

Then, fill in the form as follows

![bse-11](/assets/images/tutorial/bot-studio/bse-11.png)

### Create State init

Next, we will create a state called `init`. Click the ”+” button at the bottom right of your screen.

![bse-12](/assets/images/tutorial/bot-studio/bse-12.png)
...
![bse-13](/assets/images/tutorial/bot-studio/bse-13.png)

Now we will create a bot response to display an apology message. Click “Add actions” button to create a response.

![bse-14](/assets/images/tutorial/bot-studio/bse-14.png)

Container for creating action will appear

![bse-15](/assets/images/tutorial/bot-studio/bse-15.png)

### Create Action Text in State init

Click on “+” button to create a new action.

![bse-16](/assets/images/tutorial/bot-studio/bse-16.png)

Choose action type “Text”

![bse-17](/assets/images/tutorial/bot-studio/bse-17.png)

Then, fill in the form

![bse-18](/assets/images/tutorial/bot-studio/bse-18.png)

Click on “Create Action” button.

![bse-19](/assets/images/tutorial/bot-studio/bse-19.png)
...
![bse-20](/assets/images/tutorial/bot-studio/bse-20.png)

Click “Create” button. Your screen should look like this

![bse-21](/assets/images/tutorial/bot-studio/bse-21.png)
...
![bse-22](/assets/images/tutorial/bot-studio/bse-22.png)

Created flow will be shown like this

![bse-23](/assets/images/tutorial/bot-studio/bse-23.png)
...
![bse-24](/assets/images/tutorial/bot-studio/bse-24.png)

Next, click on “Create NLU”

![bse-25](/assets/images/tutorial/bot-studio/bse-25.png)

Choose Keyword type and enter keywords that represents `order`, such as “order”, “pls order”, “order pza”.

![bse-26](/assets/images/tutorial/bot-studio/bse-26.png)

Successfully created NLU looks like this

![bse-27](/assets/images/tutorial/bot-studio/bse-27.png)
...
![bse-28](/assets/images/tutorial/bot-studio/bse-28.png)
...
![bse-29](/assets/images/tutorial/bot-studio/bse-29.png)

Click “Create” to create the intent. Your screen should look like this

![bse-30](/assets/images/tutorial/bot-studio/bse-30.png)
...
![bse-31](/assets/images/tutorial/bot-studio/bse-31.png)
...
![bse-33](/assets/images/tutorial/bot-studio/bse-33.png)
...
![bse-39](/assets/images/tutorial/bot-studio/bse-39.png)

Then, remove all actions in the state by clicking “x” on each action.

![bse-40](/assets/images/tutorial/bot-studio/bse-40.png)
...
![bse-41](/assets/images/tutorial/bot-studio/bse-41.png)

Enter `pizzaMenu` as name

![bse-42](/assets/images/tutorial/bot-studio/bse-42.png)
...
![bse-43](/assets/images/tutorial/bot-studio/bse-43.png)

Your second form should look like this

![bse-44](/assets/images/tutorial/bot-studio/bse-44.png)

Finalize this step by clicking “Create Action.”

It should look like this

![bse-45](/assets/images/tutorial/bot-studio/bse-45.png)
...
![bse-46](/assets/images/tutorial/bot-studio/bse-46.png)

After you select `askOptions` action click “Create Action” button to finalize this step.

![bse-47](/assets/images/tutorial/bot-studio/bse-47.png)

Your form should look like this

![bse-48](/assets/images/tutorial/bot-studio/bse-48.png)
...
![bse-49](/assets/images/tutorial/bot-studio/bse-49.png)

Click on Create Intent and create intent as follow

![bse-50](/assets/images/tutorial/bot-studio/bse-50.png)

Successfully created intent looks like this

![bse-51](/assets/images/tutorial/bot-studio/bse-51.png)
...
![bse-52](/assets/images/tutorial/bot-studio/bse-52.png)

Fill in the form with these data, and click “Create”

![bse-52-1](/assets/images/tutorial/bot-studio/bse-52-1.png)
...
![bse-53](/assets/images/tutorial/bot-studio/bse-53.png)
...
![bse-54](/assets/images/tutorial/bot-studio/bse-54.png)

Then you have to make self-transition in Transition tab as follow

![bse-54_1](/assets/images/tutorial/bot-studio/bse-54_1.png)

Result:

![bse-55](/assets/images/tutorial/bot-studio/bse-55.png)
...
![bse-56](/assets/images/tutorial/bot-studio/bse-56.png)

Successfully created NLU will be shown like this

![bse-57](/assets/images/tutorial/bot-studio/bse-57.png)
...
![bse-58](/assets/images/tutorial/bot-studio/bse-58.png)

Successfully created intent will look like this

![bse-59](/assets/images/tutorial/bot-studio/bse-59.png)
...
![bse-60](/assets/images/tutorial/bot-studio/bse-60.png)

Created transition will look like this

![bse-61](/assets/images/tutorial/bot-studio/bse-61.png)
...
![bse-62](/assets/images/tutorial/bot-studio/bse-62.png)

Successfully created NLU will look like this
![bse-63](/assets/images/tutorial/bot-studio/bse-63.png)
...
![bse-64](/assets/images/tutorial/bot-studio/bse-64.png)

## Add mapping in onTransit tab

![bse-67](/assets/images/tutorial/bot-studio/bse-67.png)

Don't forget to add self-transition in a state. Click Create Action. Your screen should look like this

![bse-65](/assets/images/tutorial/bot-studio/bse-65.png)
...
![bse-66](/assets/images/tutorial/bot-studio/bse-66.png)

Result will be shown as follows

![bse-68](/assets/images/tutorial/bot-studio/bse-68.png)
...
![bse-69](/assets/images/tutorial/bot-studio/bse-69.png)

Then, we will create an intent for keyword `no`

![bse-70](/assets/images/tutorial/bot-studio/bse-70.png)

Both intent will appear as follows

![bse-71](/assets/images/tutorial/bot-studio/bse-71.png)
...
![bse-72](/assets/images/tutorial/bot-studio/bse-72.png)

![bse-73](/assets/images/tutorial/bot-studio/bse-73.png)

Also, don't forget to add self transition in the state. Result:
![bse-74](/assets/images/tutorial/bot-studio/bse-74.png)
...
![bse-75](/assets/images/tutorial/bot-studio/bse-75.png)

Final flow:

![bse-76](/assets/images/tutorial/bot-studio/bse-76.png)
...
![bse-77](/assets/images/tutorial/bot-studio/bse-77.png)

![bse-78](/assets/images/tutorial/bot-studio/bse-78.png)

Every time you publish a bot, it will record a hash number (similar to Git's hash number) in Revision List.

![bse-79](/assets/images/tutorial/bot-studio/bse-79.png)

## Testing Your Chatbot

Click on Test Chatbot on Bot Studio then type “order” to initialize `order` flow.

![bse-80](/assets/images/tutorial/bot-studio/bse-80.png)
...
![bse-81](/assets/images/tutorial/bot-studio/bse-81.png)

Click on Create Deployment button on top right

![bse-82](/assets/images/tutorial/bot-studio/bse-82.png)

Choose Patch on Deployment Version.

![bse-83](/assets/images/tutorial/bot-studio/bse-83.png)

Succesfully created deployment looks like this.

![bse-84](/assets/images/tutorial/bot-studio/bse-84.png)
...
![bse-85](/assets/images/tutorial/bot-studio/bse-85.png)
...
![bse-86](/assets/images/tutorial/bot-studio/bse-86.png)

Successfully created environment will look like this

![bse-87](/assets/images/tutorial/bot-studio/bse-87.png)
...
![bse-88](/assets/images/tutorial/bot-studio/bse-88.png)

Next, click “Create Channel” and fill in as follows

![bse-89](/assets/images/tutorial/bot-studio/bse-89.png)
...
![bse-90](/assets/images/tutorial/bot-studio/bse-90.png)

Click on Log in with LINE

![bse-91](/assets/images/tutorial/bot-studio/bse-91.png)

Enter your email and password

![bse-92](/assets/images/tutorial/bot-studio/bse-92.png)

After you successfully logged in, you will be redirected to provider list dashboard

![bse-93](/assets/images/tutorial/bot-studio/bse-93.png)

**Create a Provider**

Click “Create New Provider”

![bse-94](/assets/images/tutorial/bot-studio/bse-94.png)

Fill in provider name

![bse-95](/assets/images/tutorial/bot-studio/bse-95.png)
...
![bse-96](/assets/images/tutorial/bot-studio/bse-96.png)

### Setup Channel for LINE Integration

Setup channel in Messaging API by clicking Create Channel on Messaging API.

![bse-97](/assets/images/tutorial/bot-studio/bse-97.png)

Fill in the form as follows

![bse-98](/assets/images/tutorial/bot-studio/bse-98.png)

![bse-99](/assets/images/tutorial/bot-studio/bse-99.png)

Next, you have to choose **Developer Trial as Plan**

![bse-100](/assets/images/tutorial/bot-studio/bse-100.png)Continue to click Confirm.

Accept Terms of Use from LINE then click Create

![bse-101](/assets/images/tutorial/bot-studio/bse-101.png)

Successfuly created channel will look like this

![bse-102](/assets/images/tutorial/bot-studio/bse-102.png)
...
![bse-103](/assets/images/tutorial/bot-studio/bse-103.png)

Then, issue dialog will pop up. Click on Issue to continue

![bse-104](/assets/images/tutorial/bot-studio/bse-104.png)

Then, copy Channel Access Token below and paste it on Create Channel form in Kata | Platform

![bse-105](/assets/images/tutorial/bot-studio/bse-105.png)

![bse-106](/assets/images/tutorial/bot-studio/bse-106.png)

**Fill in Channel Secret field**

In Basic Information, copy Channel Secret from LINE to Kata | Platform

![bse-107](/assets/images/tutorial/bot-studio/bse-107.png)

![bse-108](/assets/images/tutorial/bot-studio/bse-108.png)

Final result in Kata | Platform will look like this

![bse-109](/assets/images/tutorial/bot-studio/bse-109.png)

Click “Create” to generate webhook URL from Kata | Platform.

![bse-110](/assets/images/tutorial/bot-studio/bse-110.png)
...
![bse-111](/assets/images/tutorial/bot-studio/bse-111.png)
Click “Update” then paste the webhook URL to LINE developer console.

![bse-112](/assets/images/tutorial/bot-studio/bse-112.png)

Click “Update” then click “Verify.”

![bse-113](/assets/images/tutorial/bot-studio/bse-113.png)

Next, disable auto-reply messages and greeting messages

![bse-114](/assets/images/tutorial/bot-studio/bse-114.png)

Voila! You have successfully deployed your bot to LINE Messenger.

Scan the QR Code in LINE Developer Console to add the bot.

![bse-115](/assets/images/tutorial/bot-studio/bse-115.png)

Then, test to scan QR Code

![bse-116](/assets/images/tutorial/bot-studio/bse-116.png)
