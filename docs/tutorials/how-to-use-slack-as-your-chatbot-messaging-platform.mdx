...
<FigureImage
  caption={{ title: 'Figure 5', description: `Verification Token` }}
...
<FigureImage
  caption={{ title: 'Figure 6', description: `Filling Scopes` }}
...
<FigureImage
  caption={{ title: 'Figure 7', description: `Bot User` }}
...
<FigureImage
  caption={{ title: 'Figure 8', description: `Install App to Workspace.` }}
...
<FigureImage
  caption={{ title: 'Figure 9', description: `Paste App Secret from Slack here.` }}
...
<FigureImage
  caption={{ title: 'Figure 11', description: `Event Subscription menu.` }}
...
<FigureImage
  caption={{ title: 'Figure 12', description: `Turn on Enable Events toggle.` }}
...
<FigureImage
  caption={{ title: 'Figure 13', description: `Request URL` }}
...
<FigureImage
  caption={{ title: 'Figure 14', description: ` Subscribe bot events` }}
...
<FigureImage
  caption={{ title: 'Figure 15', description: `Workspace Search` }}
...
<FigureImage
  caption={{ title: 'Figure 16', description: `Successfully deployed Slack bot` }}
  src="/assets/images/tutorials/how-to-use-slack-as-your-chatbot-messaging-platform/image16.webp"
  alt="How to use Slack as your chatbot messaging platform"
/>
