...
<Table>
  ...
  <TableBody>
    ...
    <TableBodyRow>
      ...
      <TableBodyCell>
        {' '}
        Choose the color you want to be the identifier of the label. This color will be reflected on the sidebar and your
        conversation{' '}
      </TableBodyCell>
    </TableBodyRow>
    <TableBodyRow>
      ...
      <TableBodyCell>
        {' '}
        If you tick the label on the sidebar, the label will show up on your sidebar,If you untick then the label will not
        show up on your sidebar{' '}
      </TableBodyCell>
    </TableBodyRow>
  </TableBody>
</Table>
